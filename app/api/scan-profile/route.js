...
Reply with ONLY a JSON object, no other text, in exactly this shape:
{
  ...
  "rateSuggestion": {
    ...
    "note": "one short sentence naming the actual signal used (jobs completed, Job Success Score, portfolio, skills) and explaining the suggestion, never mentioning or comparing to any dollar figure seen in the screenshot, or null"
  }
}
